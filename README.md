...
## Запуск без клонирования проекта
- Скачать Веб-интерфейс- https://github.com/zhukovsd/currency-exchange-frontend/
- В файле js/app.js параметр host поменять "http://195.133.26.31:8080/"
- Запустить файл launch-local-nginx.sh, затем и index.html
